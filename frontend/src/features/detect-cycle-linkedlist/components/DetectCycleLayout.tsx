...
import { useDetectCycle } from "../useDetectCycle";
...
export function DetectCycleLayout() {
  ...
  // Compute hasCycle from pointers
  const hasCycle = displayStep?.pointers.hasCycle ?? null;

  return (
    <LinkedListShell
      title="Detect Cycle in Linked List"
      subtitle="Floyd's Cycle Detection Algorithm with slow/fast pointers"
      ...
      stats={[
        ...
        {
          label: "Cycle",
          value: hasCycle === true ? "Yes" : hasCycle === false ? "No" : "—",
