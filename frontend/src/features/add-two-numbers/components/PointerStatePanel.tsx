      ...
      <div className="flex flex-col gap-2">
        <div className="rounded-[10px] border border-slate-200 bg-white p-3">
          ...
          <div className="grid grid-cols-2 gap-2">
            <div>
              <p className="text-[9px] text-slate-500">l1</p>
              <p className="text-sm font-semibold text-slate-800">
                {activeStep?.pointers.l1 ?? "null"}
              </p>
            </div>
            <div>
              <p className="text-[9px] text-slate-500">l2</p>
              <p className="text-sm font-semibold text-slate-800">
                {activeStep?.pointers.l2 ?? "null"}
              </p>
            </div>
            <div>
            ...
            <div>
              <p className="text-[9px] text-slate-500">carry</p>
              <p className="text-sm font-semibold text-slate-800">
                {activeStep?.pointers.carry ?? 0}
              </p>
            </div>
          </div>
        </div>
