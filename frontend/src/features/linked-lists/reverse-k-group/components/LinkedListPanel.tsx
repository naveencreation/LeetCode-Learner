  ...
  return (
    <section className="traversal-panel grid h-full min-h-0 overflow-hidden grid-rows-[auto_auto_1fr] gap-2 p-2.5">
      <div className="traversal-panel-header">
        <h2 className="traversal-panel-title">Reverse k-Group</h2>
      ...
      <div className="grid grid-cols-3 gap-1.5 rounded-[10px] border border-slate-200 bg-white/85 p-1.5">
        ...
        <div className="rounded-lg border border-violet-200 bg-violet-50 px-2 py-1 text-center">
          <p className="text-[9px] font-bold uppercase tracking-wide text-violet-600">k</p>
          <p className="text-[11px] font-extrabold text-violet-800">{activeStep?.pointers.k ?? 3}</p>
        </div>
      </div>
