...
import { usePalindromeLinkedList } from "../usePalindromeLinkedList";
...
export function PalindromeLinkedListLayout() {
  ...
  return (
    <LinkedListShell
      ...
      subtitle="Check if a linked list is a palindrome"
      guideHref="/problems/linked-list/palindrome-linkedlist-guide"
      currentHref="/problems/linked-list/palindrome-linkedlist"
      stats={[
        ...
        {
          label: "Result",
          value: currentPhase === "Result" ? (currentOperation.includes("YES") ? "Yes" : "No") : "—",
      ...
      middleBottom={
        <ResultPanel
          isPalindrome={currentPhase === "Result" && !currentOperation.includes("NO")}
          currentPhase={currentPhase}
          currentStep={currentStep}
          totalSteps={totalSteps}
          currentOperation={currentOperation}
