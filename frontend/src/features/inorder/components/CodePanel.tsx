import { INORDER_CODE_LINES } from "../constants";
                ...
                <span className="font-[var(--font-geist-mono)]">
                  {index === 0 ? (
                    <>
                      ...
                      <span className="font-bold text-blue-300">recursiveInorder</span>(
                    ...
                    <>
                      <span className="text-slate-500">    </span>recursiveInorder(
