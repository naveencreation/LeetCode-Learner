...
interface TopViewTraversalReturn {
  root: TreeNode | null;
...
export function useTopViewTraversal(): TopViewTraversalReturn {
  const config = useMemo(
    () => ({
      generateSteps: generateTopViewExecutionSteps,
  ...
  return useGenericTraversal(config) as TopViewTraversalReturn;
}
