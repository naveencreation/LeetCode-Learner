...
import { TraversalShell } from "@/features/trees/shared/components/TraversalShell";
import { UnifiedCallStackPanel } from "@/features/trees/shared/components/UnifiedCallStackPanel";
import { UnifiedControlsBar } from "@/features/trees/shared/components/UnifiedControlsBar";

import { getCodeLineForStep } from "../selectors";
import { useHeightTraversal } from "../useHeightTraversal";
...
const TreeSetupModal = dynamic(() =>
  import("@/features/trees/inorder/components/TreeSetupModal").then((module) => module.TreeSetupModal),
);
  ...
  return (
    <TraversalShell
      ...
      stats={[
        ...
        { label: "Max Depth", value: maxHeight, minWidthClassName: "min-w-[110px]" },
      ]}
      ...
      middleBottom={
        <ResultPanel
          ...
          currentComputedHeight={currentComputedHeight}
          maxHeight={maxHeight}
      ...
      rightTop={
        <UnifiedCallStackPanel
          ...
          frameFormatter={(frame) => `maxDepth(depth=${frame.depth}, node=${frame.nodeVal})`}
        />
      }
      rightBottom={
        <ExplanationPanel
