...
import { useLc106Traversal } from "../useLc106Traversal";
...
export function Lc106Layout() {
  ...
  const { inorder, postorder } = useMemo(() => deriveTraversals(root), [root]);
  ...
  return (
    <TraversalShell
      ...
      stats={[
        ...
        { label: "Postorder Ptr", value: `${postorderPointer}`, minWidthClassName: "min-w-[110px]" },
      ]}
      ...
      middleBottom={
        <ResultPanel
          ...
          postorderPointer={postorderPointer}
