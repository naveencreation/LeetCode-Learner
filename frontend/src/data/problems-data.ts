...
export const difficultyMap: Record<string, "Easy" | "Medium" | "Hard"> = {
  // Arrays
  ...
  "Find the duplicate in an array of N+1 integers": "Medium",
  "Repeat and Missing Number": "Medium",
  "Inversion of Array": "Hard",
  ...
  "Reverse Pairs": "Hard",
  "2-Sum Problem": "Easy",
  "4-Sum Problem": "Medium",
  "Longest Consecutive Sequence": "Medium",
  "Largest Subarray with 0 sum": "Medium",
  "Count number of subarrays with given XOR": "Medium",
  "Longest Substring without repeat": "Medium",

  // Linked List
  "Reverse a LinkedList": "Easy",
  "Find the middle of LinkedList": "Easy",
  "Merge two sorted Linked Lists": "Easy",
  "Remove N-th node from back of LinkedList": "Medium",
  "Add two numbers as LinkedList": "Medium",
  "Delete a given Node when a node is given": "Medium",
  "Reorder List": "Medium",
  "Find intersection point of Y LinkedList": "Easy",
  "Detect a cycle in Linked List": "Easy",
  "Reverse a LinkedList in groups of size k": "Hard",
  "Check if a LinkedList is palindrome or not": "Easy",
  "Find the starting point of the Loop of LinkedList": "Medium",
  "Flattening of a LinkedList": "Medium",
  "Rotate a LinkedList": "Medium",
  "Clone a Linked List with random and next pointer": "Medium",
  "3-Sum": "Medium",
  ...
  "Greedy algorithm to find minimum number of coins": "Easy",
  ...
  "K-th permutation Sequence": "Hard",
  "Print all permutations of a string/array": "Medium",
  "N queens Problem": "Hard",
  "Sudoku Solver": "Hard",
  "M coloring Problem": "Medium",
  "Rat in a Maze": "Medium",
  "Word Break (print all ways)": "Hard",

  // Binary Search
  "The N-th root of an integer": "Medium",
  "Matrix Median": "Medium",
  "Find the element that appears once in a sorted array, and the rest element appears twice": "Medium",
  ...
  "Max heap, Min Heap Implementation": "Medium",
  "Kth Largest Element": "Medium",
  "Maximum Sum Combination": "Medium",
  "Find Median from Data Stream": "Hard",
  "Find median in a stream of running integers": "Hard",
  "K-th largest element in a stream": "Easy",
  "K-th largest element in an unsorted array": "Medium",
  "Merge K sorted arrays": "Medium",
  "K most frequent elements": "Medium",
  "Distinct numbers in Window": "Medium",

  // Stack & Queue
  "Implement Stack Using Arrays": "Easy",
  "Implement Queue Using Arrays": "Easy",
  "Implement Stack using Queue (using single queue)": "Easy",
  "Implement Queue using Stack (0(1) amortized method)": "Easy",
  ...
  "Roman Number to Integer and vice versa": "Easy",
  "Implement ATOI/STRSTR": "Medium",
  "Longest Common Prefix": "Easy",
  "Rabin Karp": "Medium",
  "Z-Function": "Medium",
  "KMP algo / LPS(pi) array": "Medium",
  "Minimum characters needed to be inserted in the beginning to make it palindromic": "Hard",
  ...
  "Preorder Inorder Postorder in One Traversal": "Medium",
...
export const getProblemDifficulty = (problemName: string): "Easy" | "Medium" | "Hard" =>
  difficultyMap[problemName] ?? "Medium";
