...
export default function PostorderGuidePage() {
  ...
  return (
    <section className="relative min-h-0 overflow-hidden bg-gradient-to-br from-slate-50 via-white to-amber-50/30">
      <div className="absolute inset-0 pointer-events-none bg-[radial-gradient(ellipse_at_top_right,#fef3c7_0%,transparent_50%),radial-gradient(ellipse_at_bottom_left,#ede9fe_0%,transparent_50%)]" />
