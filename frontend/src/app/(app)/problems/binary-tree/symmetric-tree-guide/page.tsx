  ...
  return (
    <main className="mx-auto max-w-5xl px-4 py-8">
      ...
      <section className="mb-10">
        ...
        <h1 className="mb-4 text-4xl font-semibold text-slate-900">Symmetric Tree</h1>
      ...
      <section className="mb-10">
        ...
        <div className="rounded-xl border border-slate-200 bg-white p-6">
          ...
          <ul className="list-inside list-disc space-y-2 text-slate-700">
            <li>Root values must be equal</li>
            <li>Left child of left tree = Right child of right tree</li>
            <li>Right child of left tree = Left child of right tree</li>
          </ul>
        </div>
      </section>
      ...
      <section className="mb-10">
        ...
        <div className="rounded-xl border border-slate-200 bg-white p-6">
          <p className="text-slate-700">LeetCode #101 - tests understanding of tree mirroring and recursive thinking.</p>
        </div>
      </section>
    </main>
  );
